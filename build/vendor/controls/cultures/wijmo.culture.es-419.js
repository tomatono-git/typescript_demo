    ...
    wijmo.culture = {
        Globalize: {
            ...
            numberFormat: {
                ...
                ',': ',',
                percent: { pattern: ['-n%', '%n'] },
                currency: { decimals: 2, symbol: 'US$', pattern: ['-$n', '$n'] }
            },
            calendar: {
                '/': '/',
                ':': ':',
                ...
                monthsAbbr: ['ene', 'feb', 'mar', 'abr', 'mayo', 'jun', 'jul', 'ago', 'sep', 'oct', 'nov', 'dic'],
                am: ['a.m.', 'a'],
                pm: ['p.m.', 'p'],
                eras: ['d.C.'],
                patterns: {
                    d: 'dd/MM/yy', D: 'dddd, d "de" MMMM "de" yyyy',
                    f: 'dddd, d "de" MMMM "de" yyyy HH:mm', F: 'dddd, d "de" MMMM "de" yyyy HH:mm:ss',
                    t: 'HH:mm', T: 'HH:mm:ss',
                    m: 'd" de "MMMM', M: 'd" de "MMMM',
                    y: 'MMMM yyyy', Y: 'MMMM yyyy',
                    g: 'dd/MM/yy HH:mm', G: 'dd/MM/yy HH:mm:ss',
